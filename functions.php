...
<div class="navigation">
  ...
  <nav class="navigation__nav">
    <ul class="navigation__list">
      ...
      <li class="navigation__item"><a href="#" class="navigation__link open-modal">Get in Touch</a></li>
    </ul>
  </nav>
</div><!-- .navigation -->
<?php }
...
<h1>
  ...
  <?php
    // Display heading svg icons
    echo svg_icon('header__main', 'amplify');
    echo svg_icon('header__sub', 'your-brand'); ?>
</h1>
<?php }
